...
const PROCESS_KINDS: ProcessKind[] = ['text2image', 'text2video', 'image2video', 'imageRef'];
    ...
    >
      <div className="lab-canvas-wrap" ref={wrapperRef}>
        ...
        <div className="lab-toolrail">
          <button type="button" className="lab-toolrail-add" onClick={() => setAddMenuOpen((v) => !v)}>
            +
          </button>
          {addMenuOpen && (
            <div className="lab-add-menu">
              <button type="button" onClick={handleAddText}>
                {t('director.lab.addText')}
              </button>
              <div className="lab-add-menu-divider" />
              ...
              <div className="lab-add-menu-divider" />
              <div className="lab-add-menu-hint">{t('director.lab.dragHint')}</div>
            </div>
          )}
        </div>
      </div>
